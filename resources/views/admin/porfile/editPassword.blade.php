        ...
        <div class="container bg-white px-3 py-5 ">
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-end mb-3">
                    <a href="{{ route('admin.auth.profile', auth()->user()->id) }}"
                        class="btn btn-info text-white fw-bold my-auto"><i
                            class="bi bi-arrow-left-circle-fill me-2 fs-5 text-white"></i>Kembali</a>
                </div>
                @if ($errors->any())
                            ...
                            <div class="mb-3 ms-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text" onclick="togglePassword('password', this)">
                                        <i style="cursor: pointer;" class="bi bi-eye"></i>
                                    </span>
                                </div>
                            </div>
