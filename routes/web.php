...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/monev/detail/{id}',[MonevController::class, 'show'])->name('admin.monev.detail');
    Route::get('/monev/edit-keterangan-umum', [MonevController::class, 'showKeteranganUmum'])->name('admin.monev.umum');
    Route::get('/monev/edit-keterangan-perusahaan', [MonevController::class, 'showKeteranganPerusahaan'])->name('admin.monev.perusahaan');
